...
mod tests {
    ...
    // unused at the moment; represents the bplist with no user tags.
    #[allow(dead_code)]
    const USERTAGS_XATTR_VALUE_EMPTY: [u8; 42] = [
    ...
    // unused at the moment; represents the bplist with the tags 'Red', 'Blue', 'Foo'.
    #[allow(dead_code)]
    const USERTAGS_XATTR_RED_BLUE_FOO: [u8; 65] = [
        0x62, 0x70, 0x6C, 0x69, 0x73, 0x74, 0x30, 0x30, 0xA3, 0x01, 0x02, 0x03, 0x55, 0x52, 0x65,
        0x64, 0x0A, 0x36, 0x56, 0x42, 0x6C, 0x75, 0x65, 0x0A, 0x34, 0x53, 0x46, 0x6F, 0x6F, 0x08,
        0x0C, 0x12, 0x19, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x1D,
    ];
    // unused at the moment; represents the bplist with the tag 'Foo'.
    #[allow(dead_code)]
    const USERTAGS_XATTR_FOO: [u8; 48] = [
        0x62, 0x70, 0x6C, 0x69, 0x73, 0x74, 0x30, 0x30, 0xA1, 0x01, 0x53, 0x46, 0x6F, 0x6F, 0x08,
        0x0A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x0E,
    ];

    // unused at the moment; represents the bplist with the tags 'Foo', 'Blue',
    // 'Red'.
    #[allow(dead_code)]
    const USERTAGS_XATTR_FOO_BLUE_RED: [u8; 65] = [
        0x62, 0x70, 0x6C, 0x69, 0x73, 0x74, 0x30, 0x30, 0xA3, 0x01, 0x02, 0x03, 0x53, 0x46, 0x6F,
        0x6F, 0x56, 0x42, 0x6C, 0x75, 0x65, 0x0A, 0x34, 0x55, 0x52, 0x65, 0x64, 0x0A, 0x36, 0x08,
        0x0C, 0x10, 0x17, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x1D,
    ];

    // FinderInfo xattr with label = Blue
    #[allow(dead_code)]
    const FINDERINFO_XATTR_RED_BLUE_FOO: [u8; 32] = [
